...
현재 설계 기준은 **v0.3**, 최신 가격기반 연구 후보는 **v0.5**입니다.
...
- 문서 업로드: 완료
- 전략 연구 및 구현: Phase 4 모멘텀·변동성 v0.5 연구 완료
- 후보 임계값·목표비중: 실전 미승인
- 자동주문: 범위 제외
- ETF 기준선: `main` / `b0cecb0ef7e8e6678de9ebc34944589d9332cb54`
- 다음 단계: v0.5 규칙 고정 이후 전향 기록과 Shadow
...
- Phase 4: 1·3·6·12개월 모멘텀, 63일 변동성 예산, 실제 Upbit 교차검증과 v0.5 연구 구현
- 연구 판정: v0.5는 과거 위험 대비 성과가 개선됐지만 사후 설계 후보이므로 실전 승인 보류
...
가격 모멘텀 연구는 [v0.5 연구 결과](./v0.5/BTC_MOMENTUM_RESEARCH_RESULT_2026-08-10.md)에서 확인합니다.
