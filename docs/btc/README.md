...
현재 설계 기준은 **v0.3**, 무반감기 가격기반 기준선은 **v0.5**, 최신 연구 결과는 **반감기 필수 오버레이 v0.6**입니다.
...
- 문서 업로드: 완료
- 전략 연구 및 구현: Phase 5 반감기 필수 v0.6 과거 연구 완료
...
- Phase 5: v0.5 기준선 보존, 반감기 국면 오버레이, 실제비중 리밸런싱, 고정 반감기 보유창과 사후 최적 상한 v0.6 구현·실행 완료
- 검증: 전체 55개 테스트, 최신 무료 데이터 새로고침, 결과 산출물 검증, GitHub Actions artifact 생성 완료
...
- [v0.6 연구 결과](./v0.6/BTC_HALVING_RESEARCH_RESULT_2026-08-10.md)
